...
const Resenas = () => {
    ...
    const resenas = [
        ...
        {
            title: "Autonomía para dormir",
            text: "Nuestro peque se dormía siempre al pecho y en cada despertar lo necesitaba para conciliar, tenía que irme a la cama con él sin cenar, no teníamos tiempo en pareja y además yo (la madre) trabajo 3 noches al mes que en casa eran una tortura porque no estaba. Ahora se duerme en la cuna, con madre, padre y abuelos, y las guardias no son un drama. Hemos pasado de tener 8-10 despertares a tener 1-3 y poder regularse sin pecho. Nuestra calidad de vida ha mejorado mucho.",
            autor: "M y B"
        }
